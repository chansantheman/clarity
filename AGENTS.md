...
Optional and **not currently installed**: `npx skills add callstack/agent-device` adds the skill
that teaches agents the command surface. Worth adding — it is the difference between the CLI being
available and it being used.
